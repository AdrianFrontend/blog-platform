...
const EditArticle = ({ currentTitle, currentDescription, currentText, currentTags, locationPath, setEditMode }) => {
	const [tagFieldMaxId, setTagFieldMaxId] = useState(currentTags.length);
	...
	const onSubmit = () => {
		...
		articlesAPI.editArticle({ ...creds, tags, path: locationPath });
	};

	return (
		<div className={s.EditArticle}>
			<div className={s.title}>Edit article</div>
